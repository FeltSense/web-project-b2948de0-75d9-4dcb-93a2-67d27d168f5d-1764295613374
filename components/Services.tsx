...
const services = [
  {
    ...
    description: 'AI-powered insights into employee sentiment and workplace dynamics',
  },
  {
    icon: BarChart3,
    title: 'Engagement Metrics',
    description: 'Real-time dashboards tracking team morale and productivity trends',
  },
  {
    icon: Users,
    title: 'Team Intelligence',
    description: 'Deep analysis of collaboration patterns and team performance',
  },
  {
    icon: Zap,
    title: 'Predictive Alerts',
    description: 'Early warning system for attrition risk and burnout signals',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-500 max-w-3xl mx-auto">
            Transform raw employee data into actionable culture intelligence that drives retention and performance
          </p>
        </motion.div>
